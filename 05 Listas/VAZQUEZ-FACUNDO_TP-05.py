...
lista_deportes = ["Futbol", "Basquet", "Natacion", "Voley", "Skate"]
lista_deportes_penultimo = lista_deportes[-2]
print(lista_deportes_penultimo)
...
lista_vacia = []
lista_vacia.append("Matias")
lista_vacia.append("Facundo")
lista_vacia.append("Julian")
print(lista_vacia)
...
# Creamos una lista unicamente de numeros, que no siguen un orden con la informacion que tenemos.
numeros = [8, 15, 3, 22, 7] 

# El metodo remove sobre la lista numeros funciona para remover el elemento indicado. En este caso con la funcion max sobre la lista numeros logramos buscar el valor maximo dentro de dicha lista. Asi de esta forma estariamos removiendo el maximo valor de la lista. 
numeros.remove(max(numeros))  

# Imprimimos por pantalla el resultado de la lista que seria numero = [8, 15, 3, 7]
print(numeros)
